...
const system = [
  ...
  "3) ALWAYS keep numbers and food units (e.g., '250g', '2', '1 cup','1 Whole').",
  ...
  "10) If the user misspells a food name, you MUST automatically correct it to the closest real food name (e.g., 'bnana' → 'banana', 'chikn brest' → 'chicken breast').",
